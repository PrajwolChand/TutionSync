 ...
 * @author prajwol
 */
public class PredictFees111copy extends javax.swing.JFrame {

    /**
     * Creates new form PredictFees
     */
    public PredictFees111copy() {
        initComponents();
    }
    
public void predictFees111() {
    ...
    try (Connection con = DBConnection.getConnection()) {
        ...
        for (long i = 0; i <= daysBetween; i++) {
            ...
            // Add the predicted total to the overall total, with an added base amount
            totalPredicted += predictedTotal + 9000;  // Adding a constant daily collection
...
public double computeCost(double[] x, double[] y, double[] theta) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 60, 60));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel6.setText("Predict Fees");
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 660, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PredictFees111copy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PredictFees111copy().setVisible(true);
            }
        });
    }
