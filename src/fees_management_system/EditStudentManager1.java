 ...
 * @author prajwol
 */
public class EditStudentManager1 extends javax.swing.JFrame {

    /**
     * Creates new form EditCourse
     */
    DefaultTableModel model;
    public EditStudentManager1() {
        initComponents();
        setRecordsToTable();
    }
...
private void fetchStudentDataAndUpdateLabel(String rollNo) {
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        // TODO add your handling code here:
        EditStudentManager1 es=new EditStudentManager1();
        es.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStudentManager1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditStudentManager1().setVisible(true);
            }
        });
    }
