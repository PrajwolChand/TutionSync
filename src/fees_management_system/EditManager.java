...
public class EditManager extends javax.swing.JFrame {
  ...
  public void setRecordsToTable() {
    try {
        ...
        PreparedStatement pst = con.prepareStatement("SELECT * FROM manager_details ORDER BY manager_id ASC");
        ...
        while (rs.next()) {
            ...
            Object[] obj = {managerId, mname, password}; // Use decryptedPassword if you choose to decrypt

            model = (DefaultTableModel) tbl_managerData.getModel();
            model.addRow(obj);
            tbl_managerData.getTableHeader().setFont(new Font("SansSerif", Font.PLAIN, 18));
        }
    } catch (Exception e) {
        e.printStackTrace();
    }
...
public void clearTable() {
    DefaultTableModel model = (DefaultTableModel) tbl_managerData.getModel();
    model.setRowCount(0);
}

public void addManager(int managerId, String mname, String password) {
    try {
        Connection con = DBConnection.getConnection();
        PreparedStatement pst = con.prepareStatement("insert into manager_details values(?,?,?)");
        ...
        if (rowCount == 1) {
            ...
            JOptionPane.showMessageDialog(this, "Manager insertion failed");
        }
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Manager insertion failed");
        e.printStackTrace();
...
public void update(int managerId, String mname, String password) {
    try {
        Connection con = DBConnection.getConnection();
        PreparedStatement pst = con.prepareStatement("update manager_details set manager_name = ?, password = ? where manager_id = ?");
        ...
        pst.setString(2, encryptedPassword); // Use the encrypted password
        ...
        if (rowCount == 1) {
            ...
            JOptionPane.showMessageDialog(this, "Manager update failed");
        }
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Manager update failed");
        e.printStackTrace();
...
public void delete(int managerId) {
    try {
        Connection con = DBConnection.getConnection();
        PreparedStatement pst = con.prepareStatement("delete from manager_details where manager_id = ?");
        ...
        if (rowCount == 1) {
            ...
            JOptionPane.showMessageDialog(this, "Manager deletion failed");
        }
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Manager deletion failed");
        e.printStackTrace();
...
public String customEncryptPassword(String password, int key) {
    ...
    private void initComponents() {
        ...
        tbl_managerData = new javax.swing.JTable();
        txt_managerName = new javax.swing.JTextField();
        ...
        tbl_managerData.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tbl_managerData.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Manager Id", "Manager Name", "Password "
            }
        ));
        tbl_managerData.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_managerDataMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_managerData);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 550, 450));

        txt_managerName.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel1.add(txt_managerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, 170, 40));
        ...
        jPanel1.add(txt_managerId, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 180, 170, 40));

        lbl_courseName.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lbl_courseName.setForeground(new java.awt.Color(255, 255, 255));
        lbl_courseName.setText("Manager  Name :");
        ...
        lbl_courseId.setText("Manager Id       :");
        jPanel1.add(lbl_courseId, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, 160, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int id = Integer.parseInt(txt_managerId.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int manager_id = Integer.parseInt(txt_managerId.getText());
        String mname=txt_managerName.getText();
        String password= txt_password.getText();
        
        
        update(manager_id, mname, password );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String password= txt_password.getText();
         ...
         addManager(manager_id, mname, password );
        
       
    }//GEN-LAST:event_jButton3ActionPerformed

    private void tbl_managerDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_managerDataMouseClicked
        // TODO add your handling code here:
        
        int rowNo =tbl_managerData.getSelectedRow();
        TableModel model= tbl_managerData.getModel();
        txt_managerId.setText(model.getValueAt(rowNo, 0).toString());
        txt_managerName.setText((String)model.getValueAt(rowNo, 1));
        txt_password.setText(model.getValueAt(rowNo, 2).toString());
        
    }//GEN-LAST:event_tbl_managerDataMouseClicked
    ...
    private javax.swing.JTable tbl_managerData;
    private javax.swing.JTextField txt_managerId;
    private javax.swing.JTextField txt_managerName;
