...
public class EditStudent1 extends javax.swing.JFrame {
    ...
    public EditStudent1() {
     ...
     // Method to set records from the database to the table with decrypted passwords
    public void setRecordsToTable() {
        try {
            ...
            // Decryption key used during encryption
            int key = 7; // Same key used for XOR in customEncryptPassword
            ...
            while (rs.next()) {
                ...
                String decryptedPassword = customDecryptPassword(encryptedPassword, key);

                // Add the decrypted password to the table
                Object[] obj = {studentId, sname, rollno, decryptedPassword};
    ...
    // Method to add a new student with encrypted password
    ...
    // Method to update a student's details with encrypted password
...
private void fetchStudentDataAndUpdateLabel(String rollNo) {
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        // TODO add your handling code here:
        EditStudent1 es= new EditStudent1();
        es.show();
        this.dispose();
