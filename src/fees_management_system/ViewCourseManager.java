 ...
 * @author prajwol
 */
public class ViewCourseManager extends javax.swing.JFrame {

    /**
     * Creates new form ViewCourse
     */
    public ViewCourseManager() {
        initComponents();
        setRecordsToTable();
    }
...
tbl_courseData.getTableHeader().setFont(new Font("SansSerif", Font.PLAIN, 18));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCourseManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCourseManager().setVisible(true);
            }
        });
    }
