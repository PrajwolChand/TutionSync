 ...
 * @author prajwol
 */
public class PredictFees111 extends javax.swing.JFrame {

    /**
     * Creates new form PredictFees
     */
    public PredictFees111() {
        initComponents();
    }
...
public double exponentialSmoothing(List<Double> data, double alpha) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 660, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PredictFees111.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PredictFees111().setVisible(true);
            }
        });
    }
