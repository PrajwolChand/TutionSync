 ...
 * @author prajwol
 */
public class EditAccountant1 extends javax.swing.JFrame {

    /**
     * Creates new form EditCourse
     */
    DefaultTableModel model;
    public EditAccountant1() {
        initComponents();
        setRecordsToTable();
    }
...
public String customDecryptPassword(String encryptedPassword, int key) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAccountant1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAccountant1().setVisible(true);
            }
        });
    }
