 ...
 * @author prajwol
 */
public class ViewAllRecordsManager extends javax.swing.JFrame {

    /**
     * Creates new form ViewAllRecords
     */
    public ViewAllRecordsManager() {
        initComponents();
        setRecordsToTable();
    }
...
tbl_studentdata.getTableHeader().setFont(new Font("SansSerif", Font.PLAIN, 18));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 890, 470));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllRecordsManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllRecordsManager().setVisible(true);
            }
        });
    }
