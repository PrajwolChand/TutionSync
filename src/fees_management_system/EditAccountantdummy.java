 ...
 * @author prajwol
 */
public class EditAccountantdummy extends javax.swing.JFrame {

    /**
     * Creates new form EditCourse
     */
    DefaultTableModel model;
    public EditAccountantdummy() {
        initComponents();
        setRecordsToTable();
    }
...
tbl_accountantData.getTableHeader().setFont(new Font("SansSerif", Font.PLAIN, 18));
    ...
    e.printStackTrace();
     ...
     public void addaccountant(int accountantId, String aname, String password ) {//thre might be error here thre roll no is set as string
...
JOptionPane.showMessageDialog(this, "Accountant added succesfully");
clearTable();
setRecordsToTable();
...
JOptionPane.showMessageDialog(this, "Accounatnt insertion failed");
...
JOptionPane.showMessageDialog(this, "Accounatnt updated  succesfully");
clearTable();
setRecordsToTable();
...
JOptionPane.showMessageDialog(this, "Accounatnt updation failed");
...
e.printStackTrace();
     ...
     public void delete(int accountant_id){
...
JOptionPane.showMessageDialog(this, "Accounatnt deleted  succesfully");
clearTable();
setRecordsToTable();
...
JOptionPane.showMessageDialog(this, "Accounatnt deletion failed");
...
e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAccountantdummy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAccountantdummy().setVisible(true);
            }
        });
    }
